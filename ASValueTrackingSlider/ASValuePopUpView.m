...
{
    //[[_attributedString mutableString] setString:[NSString stringWithFormat:@"年收益率 %@",string]];//原来的
    [[_attributedString mutableString] setString:[NSString stringWithFormat:@"期望年化收益率 %@",string]];
