...
@optional
-(void)itemSelectIndex:(NSInteger)itemIndex;
...
@property  (nonatomic,strong)  UIScrollView *mainView;// UIScrollView


@property(nonatomic,strong) SCNavTabBar     *navTabBar;
@property(nonatomic,assign) CGRect barFrame;//选项卡的位置，大小
@property(nonatomic,assign) BOOL isHaveBarFlag;//是否存在底部选项卡
