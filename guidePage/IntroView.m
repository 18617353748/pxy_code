...
- (id)initWithFrame:(CGRect)frame model:(IntroModel*)model
{
    ...
    if (self) {
        ...
        CGSize s =[Global boundingRectWithSize:CGSizeMake(frame.size.width-40, CGFLOAT_MAX) withFont:descriptionLabel.font  withNSString:descriptionLabel.text]; //[descriptionLabel.text sizeWithFont:descriptionLabel.font constrainedToSize:CGSizeMake(frame.size.width-40, CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
        
        //three lines height
        CGSize three = [Global boundingRectWithSize:CGSizeMake(frame.size.width-40, CGFLOAT_MAX) withFont:descriptionLabel.font   withNSString:@"1 \n 2 \n 3"];//[@"1 \n 2 \n 3" sizeWithFont:descriptionLabel.font constrainedToSize:CGSizeMake(frame.size.width-40, CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
